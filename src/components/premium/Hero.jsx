          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 mb-12">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-2xl text-white font-semibold hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-3"
              >
            ...
            <motion.div variants={itemVariants} className="flex items-center gap-8">
              <div className="flex -space-x-4">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-12 h-12 rounded-2xl border-3 border-navy-800 overflow-hidden shadow-xl"
                  >
                    <img
                ...
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-600 border-3 border-navy-800 flex items-center justify-center text-white text-xs font-black shadow-xl">
                  +20k
                </div>
              </div>
              <div>
