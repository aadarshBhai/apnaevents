                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <Link to="/careers" className="btn-primary px-12 py-5 text-sm uppercase tracking-[0.2em] font-bold rounded-xl shadow-xl shadow-blue-900/10">
                                Explore Careers
                            </Link>
                            <Link to="/careers" className="px-12 py-5 bg-white text-[#0d3862] border border-slate-200 rounded-xl font-bold uppercase tracking-[0.2em] text-xs hover:bg-slate-50 transition-all shadow-sm">
                                Explore Careers
                            </Link>
                        </div>
                    </motion.div>
